    ...
    def __init__(self, config):
        ...
        if config.train_dataset=='duke':
            ...
            self.samples_path = {
                ...
                'duke_gallery': os.path.join(self.duke_path, 'bounding_box_test/')}

            # load
            self._load()
        
        if config.train_dataset=='market':
            self.datasets = ['market']
            ...
            # dataset paths
            self.samples_path = {
                'market': os.path.join(self.market_path, 'bounding_box_train/'),
                'market_query': os.path.join(self.market_path, 'query/'),
                'market_gallery': os.path.join(self.market_path, 'bounding_box_test/')}
